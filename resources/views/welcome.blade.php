                ...
                <div class="flex flex-col-reverse md:flex-row items-center justify-between gap-12 w-full">
                    ...
                    <div class="md:w-2/5 flex justify-center md:justify-end mb-10 md:mb-0">
                        <div class="relative group cursor-pointer animate-float">
                            ...
                            <img src="https://ui-avatars.com/api/?name=Hermgild&background=3b82f6&color=fff&size=512" alt="Gild Photo" class="relative w-64 h-64 md:w-80 md:h-80 rounded-full object-cover border-4 border-slate-900 shadow-2xl transition-transform duration-500 group-hover:scale-105">
                        </div>
                    </div>
                </div>
            </div>
